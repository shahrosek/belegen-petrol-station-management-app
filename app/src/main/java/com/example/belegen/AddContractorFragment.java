...
public class AddContractorFragment extends Fragment {
    ...
    CollectionReference contractorRef = db.collection("Contractors");

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.add_contractor, container, false);
    }
...
//        super.onViewCreated(view, savedInstanceState);
        ...
        Button btn = view.findViewById(R.id.save_btn);
        btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                contractor.put("firstName", editText1.getText().toString());
                contractor.put("lastName", editText2.getText().toString());
                contractor.put("address",editText3.getText().toString());
                contractor.put("cnic1", editText4.getText().toString());
                contractor.put("cnic2", editText5.getText().toString());
                contractor.put("cnic3", editText6.getText().toString());
                contractor.put("number1", editText7.getText().toString());
                contractor.put("number2", editText9.getText().toString());
                contractor.put("status", status);
                contractor.put("amount", Double.valueOf(editText8.getText().toString()));

                // Add query:
                contractorRef.document().set(contractor)
...
//                            startActivity(new Intent(AddContractorFragment.this, DashboardFragment.class));
//                        }
                    }
                });
